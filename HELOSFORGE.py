...
OPENAI_API_KEY = " "  # Replace with your OpenAI API key or set via environment variable
...
class AIModelGenerator:
    ...
    def edit_stl(self, base_stl_path: str, edit_prompt: str, output_path: str, max_attempts: int = 3) -> bool:
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            #Also strip any accidental base() the model might have produced (extra safety).
...
class ModelManipulatorApp:
    ...
    def _edit_thread(self):
        try:
            ...
            #Save the *currently displayed* geometry as the base STL for editing
