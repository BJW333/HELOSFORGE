...
OPENAI_API_KEY = "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"
...
class AIModelGenerator:
    ...
    def _validate_scad(self, code: str) -> Optional[str]:
...
class ModelViewer:
    ...
    def _draw_hud(self, generating: bool):
        ...
        for i, t in enumerate(["1-5: Primitives", "S: Save", "G: Generate", "C: Camera", "ESC: Quit"]):
...
class ModelManipulatorApp:
    ...
    def _handle_key(self, key):
        ...
        elif key == K_s: self.viewer.save_mesh("output.stl")
    ...
    def _generate_thread(self):
        try:
            ...
            if prompt and self.ai.generate_stl(prompt, "ai_generated.stl"):
                self.viewer.load_mesh("ai_generated.stl")
        finally:
            self.generating = False
